            ...
            <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 bg-gradient-to-br from-purple-950/20 via-zinc-900/40 to-[#0d0d0d] border-r border-zinc-800/60 relative overflow-hidden">
                ...
                <div className="z-10 max-w-md">
                    <h2 className="text-4xl font-bold tracking-tight mb-4">
                        Join the future of digital communities.
                    </h2>
                    <p className="text-zinc-400 text-sm leading-relaxed">
                        Create an account to build your profile, showcase your collections, and interact with elite creators globally.
                    </p>
                </div>
            ...
            <div className="flex-1 flex items-center justify-center px-6 py-12 lg:px-16">
                <div className="w-full max-w-md space-y-8">
                    ...
                    <div className="flex lg:hidden items-center space-x-2 mb-8">
                        ...
                        <span className="text-xl text-purple-400 font-bold tracking-wide">Lumina</span>
                    </div>

                    <div className="space-y-2">
                        <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Create an account</h1>
                        <p className="text-sm text-zinc-400">Enter your details to get started with Lumina</p>
                    </div>
                    ...
                    <div className="relative flex py-2 items-center">
                        ...
                        <span className="shrink mx-4 text-xs text-zinc-500 uppercase tracking-widest">Or continue with</span>
                        <div className="grow border-t border-zinc-800"></div>
                    </div>
